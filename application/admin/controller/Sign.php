...
class Sign extends Base
{
    ...
    public function signList()
    {
        ...
        // $Pickup =  Db::query("select * from tp_users as a,tp_user_sign as b where a.user_id = b.user_id $where users by a.user_id desc");
    ...
    public function ajaxsignList()
    {
        ...
        // $list = M('user_sign')->group("user_id")->select();
